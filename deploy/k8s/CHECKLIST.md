...
| **GOOGLE_REDIRECT_URI** | Actuellement `localhost:8081` | Doit être `https://api.example.com/login/oauth2/code/google`. Doit correspondre à Google Cloud Console. | ☐ |
...
|--------|--------|
| Créer projet OAuth2 | ☐ |
| Ajouter URI de redirection : `https://api.example.com/login/oauth2/code/google` | ☐ |
