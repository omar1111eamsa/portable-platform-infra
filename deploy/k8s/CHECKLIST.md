...
| **GOOGLE_REDIRECT_URI** | Actuellement `localhost:8081` | Utiliser `http://203.0.113.10/api/auth/oauth2/code/google` (ou URL prod) | ☐ |
...
|--------|--------|
| Créer projet OAuth2 | ☐ |
| Ajouter URI de redirection : `http://203.0.113.10/api/auth/oauth2/code/google` (ou HTTPS en prod) | ☐ |
