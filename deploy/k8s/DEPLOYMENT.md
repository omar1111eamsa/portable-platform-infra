...
- **Répartition des services** : **backend-vm** : postgres, user-management, metamodel-orchestration ; **frontend-vm** : redis, consul, rabbitmq, frontend, chatbot, predictions-intake, crm-client, kpi-dashboard, api-gateway, payment-service.
